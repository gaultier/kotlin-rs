...
impl fmt::Display for TokenKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TokenKind::EscapeSequenceCarriageReturn => write!(f, ""),
            ...
            TokenKind::Int(i32) => write!(f, ""),
            TokenKind::Long(i64) => write!(f, ""),
            TokenKind::UInt(u32) => write!(f, ""),
            TokenKind::ULong(u64) => write!(f, ""),
            TokenKind::Float(f32) => write!(f, ""),
            TokenKind::Double(f64) => write!(f, ""),
            TokenKind::Char(char) => write!(f, ""),
            TokenKind::Shebang => write!(f, ""),
            TokenKind::Comment => write!(f, ""),
            TokenKind::TString => write!(f, ""),
            TokenKind::Bool(bool) => write!(f, ""),
            TokenKind::Null => write!(f, ""),
            TokenKind::KeywordAbstract => write!(f, ""),
            TokenKind::KeywordActual => write!(f, ""),
            TokenKind::KeywordAnnotation => write!(f, ""),
            TokenKind::KeywordAs => write!(f, ""),
            TokenKind::KeywordBy => write!(f, ""),
            TokenKind::KeywordCatch => write!(f, ""),
            TokenKind::KeywordClass => write!(f, ""),
            TokenKind::KeywordCompanion => write!(f, ""),
            TokenKind::KeywordConst => write!(f, ""),
            TokenKind::KeywordConstructor => write!(f, ""),
            TokenKind::KeywordContinue => write!(f, ""),
            TokenKind::KeywordCrossinline => write!(f, ""),
            TokenKind::KeywordData => write!(f, ""),
            TokenKind::KeywordDelegate => write!(f, ""),
            TokenKind::KeywordDo => write!(f, ""),
            TokenKind::KeywordDynamic => write!(f, ""),
            TokenKind::KeywordElse => write!(f, ""),
            TokenKind::KeywordEnum => write!(f, ""),
            TokenKind::KeywordExpect => write!(f, ""),
            TokenKind::KeywordExternal => write!(f, ""),
            TokenKind::KeywordField => write!(f, ""),
            TokenKind::KeywordFile => write!(f, ""),
            TokenKind::KeywordFinal => write!(f, ""),
            TokenKind::KeywordFinally => write!(f, ""),
            TokenKind::KeywordFor => write!(f, ""),
            TokenKind::KeywordFun => write!(f, ""),
            TokenKind::KeywordGet => write!(f, ""),
            TokenKind::KeywordIf => write!(f, ""),
            TokenKind::KeywordImport => write!(f, ""),
            TokenKind::KeywordIn => write!(f, ""),
            TokenKind::KeywordInfix => write!(f, ""),
            TokenKind::KeywordInit => write!(f, ""),
            TokenKind::KeywordInline => write!(f, ""),
            TokenKind::KeywordInner => write!(f, ""),
            TokenKind::KeywordInterface => write!(f, ""),
            TokenKind::KeywordInternal => write!(f, ""),
            TokenKind::KeywordIs => write!(f, ""),
            TokenKind::KeywordLateinit => write!(f, ""),
            TokenKind::KeywordNoinline => write!(f, ""),
            TokenKind::KeywordObject => write!(f, ""),
            TokenKind::KeywordOpen => write!(f, ""),
            TokenKind::KeywordOperator => write!(f, ""),
            TokenKind::KeywordOut => write!(f, ""),
            TokenKind::KeywordOverride => write!(f, ""),
            TokenKind::KeywordPackage => write!(f, ""),
            TokenKind::KeywordParam => write!(f, ""),
            TokenKind::KeywordPrintln => write!(f, ""),
            TokenKind::KeywordPrivate => write!(f, ""),
            TokenKind::KeywordProperty => write!(f, ""),
            TokenKind::KeywordProtected => write!(f, ""),
            TokenKind::KeywordPublic => write!(f, ""),
            TokenKind::KeywordReceiver => write!(f, ""),
            TokenKind::KeywordReified => write!(f, ""),
            TokenKind::KeywordReturn => write!(f, ""),
            TokenKind::KeywordSealed => write!(f, ""),
            TokenKind::KeywordSet => write!(f, ""),
            TokenKind::KeywordSetparam => write!(f, ""),
            TokenKind::KeywordSuspend => write!(f, ""),
            TokenKind::KeywordTailrec => write!(f, ""),
            TokenKind::KeywordThrow => write!(f, ""),
            TokenKind::KeywordTry => write!(f, ""),
            TokenKind::KeywordTypeof => write!(f, ""),
            TokenKind::KeywordVal => write!(f, ""),
            TokenKind::KeywordVar => write!(f, ""),
            TokenKind::KeywordVararg => write!(f, ""),
            TokenKind::KeywordWhen => write!(f, ""),
            TokenKind::KeywordWhere => write!(f, ""),
            TokenKind::KeywordWhile => write!(f, ""),
            TokenKind::Identifier => write!(f, ""),
            TokenKind::Whitespace => write!(f, ""),
            TokenKind::LineComment => write!(f, ""),
            TokenKind::BlockComment { terminated: bool } => write!(f, ""),
